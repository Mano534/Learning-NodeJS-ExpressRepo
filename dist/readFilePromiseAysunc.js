...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var first, second, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, promises_1.readFile('./src/container/readAnDwrite/first.txt', 'utf8')];
            case 1:
                first = _a.sent();
                return [4 /*yield*/, promises_1.readFile('./src/container/readAnDwrite/second.txt', 'utf8')];
            case 2:
                second = _a.sent();
                promises_1.writeFile('./src/container/readAnDwrite/IAMBOTHANDIAMAMAZING.txt', "AM BOTH of them: " + first + ", " + second, { flag: 'a' });
                console.log("data 3 promise + async:", first);
                console.log("data 3 promise + async:", second);
                return [3 /*break*/, 4];
            case 3:
